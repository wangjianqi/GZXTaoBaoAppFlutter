    ...
    var pullLoadWidget = PullLoadWidget(
      ...
      (BuildContext context, int index) {
        ...
        if (conversation.titleColor == 0xff000000 &&
            pullLoadWidgetControl.dataList[index - 1].titleColor !=
                0xff000000) {
          return Container(
            color: Colors.white,
            child: Column(
...
class TopItem extends StatelessWidget {
  ...
  TopItem({Key key, this.isShowFloatingTopBar = false, this.topBarOpacity = 1})
      : super(key: key);
          ...
          child: Container(
              ...
              child: Card(
                ...
                shape: const RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.all(Radius.circular(12.0))), //设置圆角
                child: Row(
                  ...
                  children: <Widget>[
                    _circleButton(
                        Color(0xFF32b3fb), GZXIcons.deliver_fill, '交易物流', 2),
                    _circleButton(Color(0xFFf9cd13), GZXIcons.notification_fill,
                        '通知消息', 18),
                    _circleButton(Color(0xFF7cdd22),
                        GZXIcons.comment_fill_light, '互动消息', 5),
                  ],
                ),
              )),
        ),
    ...
    return Row(
      children: <Widget>[
        ...
        Container(
          ...
          alignment: Alignment.center,
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(22 / 2.0),
              color: Color(0xFFfb8f48)),
          child: Row(
            children: <Widget>[
              Icon(
                GZXIcons.search_light,
